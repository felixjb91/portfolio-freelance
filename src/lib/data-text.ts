...
export const workExperiencePro = [
	{
		...
		achievements: [
			{ category: "tech", text: "Architecture backend modulaire et robuste dans le cloud" },
			{ category: "tech", text: "Mise en place TDD, Clean Code et Observabilité" },
			{ category: "impact", text: "Modernisation d'applications critiques d'ingestion d'œuvres" },
			{ category: "impact", text: "Optimisation de performances sur fortes volumétries" },
	...
	},
	{
		...
		techStack: [Tech.JAVA, Tech.SPRING_BOOT, Tech.AWS, Tech.POSTGRESQL, Tech.ANGULAR],
		achievements: [
	...
	},
	{
		...
		techStack: [Tech.JAVA, Tech.TYPESCRIPT, Tech.POSTGRESQL],
		achievements: [
...
export const workExperiencePerso = [
	{
		...
		techStack: [Tech.JAVA, Tech.SPRING_BOOT, Tech.LANGCHAIN4J, Tech.REACT, Tech.EXPO, Tech.SUPABASE, Tech.POSTGRESQL, Tech.TAILWINDCSS, Tech.DOCKER],
		achievements: [
			...
			{ category: "impact", text: "Expérience simple, fluide et minimaliste, adaptée à la salle de sport" },
	...
	},
	{
		...
		techStack: [Tech.JAVA, Tech.SPRING_BOOT, Tech.LANGCHAIN4J, Tech.VUE, Tech.POSTGRESQL, Tech.TAILWINDCSS, Tech.DOCKER],
		achievements: [
	...
	},
	{
		...
		techStack: [Tech.REACT, Tech.EXPO, Tech.LANGCHAIN4J, Tech.TAILWINDCSS, Tech.FIREBASE],
		achievements: [
